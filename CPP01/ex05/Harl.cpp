...
void Harl::info(){ std::cout << "I cannot believe adding extra bacon costs more money. You didn’t putenough bacon in my burger! If you did, I wouldn’t be asking for more!" << std::endl; }
...
void Harl::complain( std::string level )
{
	...
	for (i = 0; i < 4; i++)
		if (!levels[i].compare(level))
			break ;
	if (i > 3) { std::cout << "Wrong command" << std::endl; return ; }
	(this->*functions[i])();
}